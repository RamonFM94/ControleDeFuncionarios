...
{
    /// <summary>
    /// Classe de controle para realizer os fluxos de ações de funcionário
    /// </summary>
    public class FuncionarioController
    {
        /// <summary>
        /// Método para realizar o cadastro de funcionário
        /// </summary>
        public void CadastrarFuncionario()
        {
            ...
            funcionario.Tipo = (TipoDeContratacao) int.Parse(Console.ReadLine());

            #region Validação dos dados do funcionário

            //instanciando a classe de validação de funcionário
           ...
           var result = funcionarioValidator.Validate(funcionario);
            ...
            if (result.IsValid) 
            {
                ...
                //programar para gravar em banco de dados
